    ...
    <div className="bg-slate-950 text-white border-b border-slate-800/80 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2 text-[10px] text-slate-400 shrink-0">
            ...
            <a
              href="tel:0286388421"
              className="bg-slate-900/90 hover:bg-slate-800 px-2 py-0.5 rounded border border-slate-800 hover:border-slate-700 transition-colors"
